...
\item[$\bullet$] Morphisms are pairs $(f: \arr(\mc{A}), g:\arr(\mc{B}))$ satisfying the condition:
...
The \emph{limit of a diagram $D$} is defined as a terminal object of the category $(\Delta \downarrow D)$. Dually, the \emph{colimit of a diagram $E$} is defined as an initial object of the category $(E \downarrow \Delta)$.
\[
